...
/* WebGL pixel background from sktbrd/builder-deploy-direct (reactbits
   PixelBlast), the project where I shipped PR #5 — "readable text over
   animated background". Rendered only on the BuilderDAO build page,
